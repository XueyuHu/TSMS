...
AA = ["K","Rb","Cs","Ba","Na","Mg","Ca","Sr"]
Aa = ["La","Pr","Nd","Sm"]

def expand_chemical_formula(formula):
...
#formula = "Sr16Co13Sb3"
Formula = ['Ba16Co12Hf2Zr2', 'Ba16Co8Hf4Zr4', 'Ba16Co12Mo2Nb2', 'Ba16Co14Mo1Nb1', 'Ba16Co12Sc2Y2', 'Ba16Co14Sc1Y1','Ba16Co12Hf2Dy2', 'Ba16Co12Ta3Y1', 'Ba16Co10Nb3Ta3', 'Ba16Co12Ta2Sn2','Ba16Co14Hf1Sn1', 'Ba16Co14Nb1Zr1','Ba16Co12Nb2Zr2', 'Ba16Co10Nb3Zr3', 'Ba16Co12W2Dy2', 'Ba16Co12Nb2Sc2', 'Ba16Co14Nb1Sc1', 'Ba16Co14Mo1Y1', 'Ba16Co12Mo2Y2', 'Ba16Co12Sb2Y2', 'Ba16Co12Ho2W2', 'Ba16Co12Dy2Nb2', 'Ba16Co12Sc2Nb2', 'Ba16Co12Sc2Zr2', 'Ba16Co12Sb2Dy2']
for formula in Formula:
    expanded_list = expand_chemical_formula(formula)
    Output = Enlargement_Single(expanded_list)
    export_to_csv(Output,'Embedding_result_TableS7.csv')
#print(Output)

#for element in ['Al','As','Bi','Ca','Ce','Cr','Dy','Er','Ga','Ge','Hf','Ho','La','Lu','Mg','Mo','Nb','Nd','Sb','Sc','Sm','Sn','Ta','Tb','Te','Ti','Tm','V','Y','Yb','Zn','Zr']:
#    for i in range(1,9):
#        formula = 'La16Ni%d%s%d' %(16-i, element, i)
#        #print(formula)
#        Output = Enlargement_Single(expanded_list)
#        export_to_csv(Output,'Embedding_result.csv')